...
"""Unittests for models/square.py are defined.

Unittest classes:
    1-TestSquare_instantiation - @line 24
    2-TestSquare_size - @line 88
    3-TestSquare_x - @line 166
    4-TestSquare_y - @line 238
    5-TestSquare_order_of_initialization - @line 306
    6-TestSquare_area - @line 322
    7-TestSquare_stdout - @line 343
    8-TestSquare_update_args - @line 426
    9-TestSquare_update_kwargs - @line 538
    10-TestSquare_to_dictionary - @line 640
"""
import io
import sys
import unittest
...
class TestSquare_instantiation(unittest.TestCase):
    """Unittests to check Square class instantiation."""
...
class TestSquare_size(unittest.TestCase):
    """unit tests to check the Square class's size initialization."""
...
class TestSquare_x(unittest.TestCase):
    """Unittests to check the Square x attribute's initialization."""
...
class TestSquare_y(unittest.TestCase):
    """Unittests to check the Square y attribute's initialization."""
...
class TestSquare_order_of_initialization(unittest.TestCase):
    """Unittests to check the initialization sequence of Square attributes."""
...
class TestSquare_area(unittest.TestCase):
    """Unittests to check the Square class's area method."""
...
class TestSquare_stdout(unittest.TestCase):
    """Unittests to check the Square class's __str__ and show methods."""
    ...
    def capture_stdout(sq, method):
        ...
        Arguments as following:
            sq (Square): Square ot prints to standard output.
            method (str): the procedure to use sq.
        Returns:
...
class TestSquare_update_args(unittest.TestCase):
    """unit tests for the Square class's update args function."""
...
class TestSquare_update_kwargs(unittest.TestCase):
    """Unittests are used to test the Square class's update-kwargs method."""
...
class TestSquare_to_dictionary(unittest.TestCase):
    """Unit tests for the Square class's to_dictionary method."""
